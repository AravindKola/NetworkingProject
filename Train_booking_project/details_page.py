...
class details():
    ...
    def details_func(self):
        ...
        self.tickets=tktt.IntVar()
        rd_btn1 = Radiobutton(base,text=1,variable=self.tickets).place(x=50,y=280)
        rd_btn2 = Radiobutton(base,text=2,variable=self.tickets).place(x=100,y=280)
        rd_btn3 = Radiobutton(base,text=3,variable=self.tickets).place(x=150,y=280)
